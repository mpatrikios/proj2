...
int qnode_number_compare(const void *a, const void *b); // implement in list.cpp to avoid compile-time issues, used by quick, merge and stl
int qnode_string_compare(const void *a, const void *b); // implement in list.cpp to avoid compile-time issues, merge and stl
